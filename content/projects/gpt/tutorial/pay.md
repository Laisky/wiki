...
Wechat/Alipay RMB transfers are converted to USD using the fixed exchange rate 7.1:1. Crypto payments accept major stablecoins such as USDT, USDC, FDUSD, DAI, and are exchanged 1:1 with USD.
